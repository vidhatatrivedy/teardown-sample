...
This repository is a **complete Architecture Teardown deliverable** for [Chef's Console](../), a multi-tenant restaurant bulk-order booking platform. It documents what exists today, what's fragile, and the exact sequence to fix it.
